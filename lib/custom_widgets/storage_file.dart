...
import 'package:flutter_firebase_todo_app/utils/modals/images_modal.dart';
import 'package:flutter_firebase_todo_app/utils/storage_helper.dart';
import 'package:get/get.dart';

class UploadTaskListTile extends StatelessWidget {
  // ignore: public_member_api_docs
  UploadTaskListTile({Key key, this.task, this.docid}) : super(key: key);
      ...
      child: Card(
        ...
        children: [
          ...
          IconButton(
              ...
              onPressed: () async {
                storage.downloadFile(task, context);
              }),
          IconButton(
              icon: Icon(Icons.link_outlined),
              onPressed: () async {
                storage.copyURL(task, context);
              }),
        ],
      )),
    );
